...
class _VideoCallState extends State<VideoCall>
  ...
  checkAndNavigationCallingPage() async {
    ...
    if (currentCall != null) {
      navService.push(MaterialPageRoute(builder: (context)=>VideoCall(name: widget.name, isVideo: false)));
      // navService.pushNamed('/detail_screen', args: currentCall.toMap());
